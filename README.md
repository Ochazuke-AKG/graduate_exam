...
- 諸々の心理学的対処法を調べる中で、継続が課題である自分に合うと感じた方法がThree Good Things。
...
## サービスの利用イメージ
1. 夜の習慣: 寝る前にアプリを開き、今日良かったこと・幸せに感じたこと・感謝・心のお守りになった言葉などのGoodを3つ（うち1つは不安や反省のようなBadも可）を3行で入力。
...
- データベース:PostgreSQL
- デプロイ先:Render
- 使用予定のライブラリ:sorcery, kaminari, ransack, rails-i18n, rubocop